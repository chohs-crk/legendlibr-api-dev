...
[서사 문법]
- **텍스트**: 감정·주제에 관한 단어를 강조 (최대 3회)
- 텍스트 양 끝에 **를 사용한다
- §텍스트§: 직접 대사 (발화 가능한 캐릭터만)
- 캐릭터가 발화 불가일 경우
주변 인물이나 제 3자의 대사, 독백 느낌의 서술 등을 §텍스트§형태로 사용할 수 있다
...
[출력]
{
  "ending": "이야기의 엔딩을 6문장 이내의 소설로 작성한다.",
  "features": ["특징1","특징2","특징3","특징4","특징5"]
}
`;
}
